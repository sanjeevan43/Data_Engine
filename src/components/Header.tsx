        ...
        <header className="relative bg-slate-950 pt-32 pb-48 overflow-hidden">
            ...
            <div className="relative max-w-7xl mx-auto px-10 flex flex-col lg:flex-row items-center justify-between gap-16">
                <div className="space-y-8 animate-in slide-in-from-left duration-700">
                    <div className="flex items-center gap-3 px-5 py-1.5 bg-blue-500/10 border border-blue-500/20 rounded-full w-fit">
                        <div className="w-2 h-2 bg-blue-400 rounded-full animate-pulse"></div>
                        <span className="text-[10px] font-black text-blue-400 uppercase tracking-widest">v5.0 Enterprise</span>
                    </div>
                    <h1 className="text-7xl lg:text-8xl font-black text-white leading-none tracking-tighter">
                        Smart <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400">Ingest</span>
                    </h1>
                    <p className="text-2xl text-slate-400 font-medium max-w-2xl">
                        Enterprise-grade CSV pipeline with dynamic collection routing, field mapping, and accelerated batch commits.
                    </p>
                </div>
                <button
